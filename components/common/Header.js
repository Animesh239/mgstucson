    ...
    <header>
      <div className="container bg-top">
        ...
        <nav className={open ? "openMenu" : "closeMenu"}>
          ...
          <Link href="/about" className={activeLink === "/about" ? "activeLink" : ""}>
            About Us
          </Link>
          ...
          <Link href="/projects" className={activeLink === "/projects" ? "activeLink" : ""}>
            Projects
          </Link>
          <Link href="/blogs" className={activeLink === "/blogs" ? "activeLink" : ""}>
            Blog
          </Link>
          ...
          >
            <div>
              ...
              <Link
                href="/services"
                onClick={handleLinkClick}
                className={activeLink === "/services" ? "activeLink item" : "item"}
              >
                Services
              </Link>
              <Link
                href="/projects"
                onClick={handleLinkClick}
                className={activeLink === "/projects" ? "activeLink item" : "item"}
              >
                Projects
              </Link>
              <Link
              ...
              <Link
                href="/contact"
                onClick={handleLinkClick}
                className={activeLink === "/contact" ? "activeLink item" : "item"}
              >
                Contact
              </Link>
              {user ? (
                ...
                <Link href="/auth/login" onClick={handleLinkClick} className="button-primary">
                  Login
                </Link>
              )}
            </div>
